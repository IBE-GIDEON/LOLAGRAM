...
-- ---------------------------------------------------------------------------
-- 1. What each courier costs, as the seller sets it.
--
--    jsonb keyed by method id — {"topship": 25000, "gig": 15000, "dhl": 45000}
...
alter table public.orders
  ...
  check (shipping_method in ('pickup', 'local', 'topship', 'gig', 'dhl'));
