  ...
  return {
    ...
    vendors: [
      {
        ...
        paymentNote: "Send proof on WhatsApp after transfer.",
        isActive: true,
        totalSales: 214,
        rating: 4.8,
      ...
      },
      {
        ...
        accountName: "Tosin Adeyemi",
        accountNumber: "1029384756",
        paymentNote: "We confirm direct payments within a few minutes during work hours.",
        isActive: true,
        totalSales: 143,
        rating: 4.6,
      ...
      },
      {
        ...
        bankName: "UBA",
        accountName: "Ify Chukwu",
        accountNumber: "5566778899",
        paymentNote: "Pay only after your order is confirmed.",
        isActive: true,
        totalSales: 328,
        rating: 4.9,
    ...
    orders: [
      ...
      },
      {
        ...
        paymentReference: "AMARA-TRANS-002",
